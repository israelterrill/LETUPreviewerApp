...
var config = {
  ...
  less: {
    src: [
    './src/less/app.less', './src/less/responsive.less', './src/less/other-styles.less', './src/less/select.less',
    './src/less/select2.less'
    ],
    paths: [
...
gulp.task('js', function() {
    streamqueue({ objectMode: true },
      ...
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'PreviewerApp' }))
    )
...
gulp.task('copy2', ['js'], function () {
  return gulp
    .src('./components/ui-select/dist/select.min.js')
    .pipe(gulp.dest('./www/js'));
});
gulp.task('copy3', ['js'], function () {
  return gulp
    .src('./components/ui-select/dist/select.min.css')
    .pipe(gulp.dest('./www/css'));
});
gulp.task('copy4', ['js'], function () {
  return gulp
    .src('./components/ui-select/dist/select2.png')
    .pipe(gulp.dest('./www/css'));
});

gulp.task('copy5', ['js'], function () {
  return gulp
